...
async def summarize_filing(request: SummarizeRequest):
    ...
    try:
        ...
        prompt = (
            ...
            "Thoroughly read and analyze the section above to explain the drivers of the financial performance. The explanation of the numbers' drivers should be as specific and detailed as possible, using the information from the section above. Only summarize the reasons and drivers that are explicitly mentioned in the section above. Do not make up, infer, or speculate about any reasons that are not directly stated. "
            "Only use the numbers provided below. If a number is not provided, do not use or mention it at all. "
