...
async def summarize_filing(request: SummarizeRequest):
    ...
    try:
        ...
        prompt = (
            ...
            "- Focus on the overview, revenue, sales, or performance highlights in the section above, and mention only the top 1–3 main drivers in the order and with the emphasis given in the section above. "
            "- Only summarize reasons and drivers that are explicitly mentioned. Do not make up, infer, or speculate, and do not exaggerate the importance of any single factor unless it is clearly stated as the main driver. If only general terms like \"product and service revenue\" are mentioned, do not invent or specify segments. "
