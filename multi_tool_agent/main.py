...
async def summarize_filing(request: SummarizeRequest):
    ...
    try:
        ...
        prompt = (
            ...
            "- Only summarize reasons and drivers explicitly mentioned in the section above. Do not make up, infer, or speculate. "
            "- Present main drivers in the order and with the emphasis given in the section above. Do not exaggerate the importance of any single factor unless it is clearly stated as the main driver. "
