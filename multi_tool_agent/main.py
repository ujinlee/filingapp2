...
async def summarize_filing(request: SummarizeRequest):
    ...
    try:
        ...
        prompt = (
            ...
            "- If the section above states that changes in business segment revenues are the main drivers of total revenue, always mention these segments and their impact as described. "
            "- Read and analyze the section above to explain the drivers of financial performance. "
            "- Only summarize and present main drivers in the order. Do not make up, infer, or speculate, and do not exaggerate the importance of any single factor unless it is clearly stated as the main driver. "
