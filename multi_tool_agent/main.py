...
async def summarize_filing(request: SummarizeRequest):
    ...
    try:
        ...
        prompt = (
            ...
            "1. Financial performance: Summarize and compare only the official numbers for the current and previous period that are provided below. "
            "- If the section above states that changes in business segment revenues are the main drivers of total revenue, mention these segments and their impact as described. "
            "- Directly extract and restate the main points and drivers of financial performance as they are stated in the section above. Do not summarize, generalize, or infer. Use the same wording and order as in the section above whenever possible. "
            "- When extracting and restating the main points and drivers, focus on the \"overview\", \"performance\", \"revenue\", \"sales\", or similarly titled sections in the text above. "
            "- Only summarize reasons and drivers that are explicitly mentioned. Do not make up, infer, or speculate, and do not exaggerate the importance of any single factor unless it is clearly stated as the main driver. "
