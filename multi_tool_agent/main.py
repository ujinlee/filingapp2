...
async def summarize_filing(request: SummarizeRequest):
    ...
    try:
        ...
        prompt = (
            ...
            "1. Financial performance: Focus on revenue changes and their explicit explanations from the MD&A section. "
            "- First, state the official revenue numbers for the current and previous period that are provided below. "
            "- Then, extract and quote or restate ONLY the explicit explanations for revenue changes that are stated in the MD&A section. "
