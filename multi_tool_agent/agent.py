    ...
    def summarize(content: str) -> str:
        ...
        def summarize_chunk(chunk):
            prompt = (
                ...
                "- Financial metrics with specific numbers (revenue, net income, growth rates, etc.)\n"
                ...
                "- If both current and comparison period numbers are present, calculate and state the year-over-year (YoY) or quarter-over-quarter (QoQ) change as a percentage.\n"
                "- If only one period's number is present, do not mention YoY or QoQ change.\n"
