...
class TranslationAgent:
    ...
    def translate(english_script: str, target_language: str) -> str:
        ...
        if not result.strip() or len(result) < 0.7 * len(english_script):
            print(f"[TranslationAgent] GPT translation failed or incomplete (result too short), using English.")
