...
def build_podcast_prompt_from_financials(periods, revenue, net_income, eps_basic):
    # Calculate growth if both periods are present and valid
    ...
    prompt_lines.append("\nPlease generate a 3-4 minute podcast script as a conversation between Alex and Jamie, focusing on these numbers and their significance. Do not use any other numbers or invent any data. If you discuss reasons for changes, use only what is explicitly stated in the provided context.")
    return '\n'.join(prompt_lines)
